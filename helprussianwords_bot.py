...
gram_list = gram.keys()
path_to_db = 'C:/Users/detec/PycharmProject/yandex_and_kirienko179/words_of_users.sqlite'
path_to_dir_of_mems = 'C:/Users/detec/PycharmProject/yandex_and_kirienko179/mems'
...
reply_keyboard_act = [['/check', '/meaning', '/morfem'], ['/fon', '/morfol', '/mem', '/end']]
